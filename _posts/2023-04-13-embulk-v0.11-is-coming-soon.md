...
After v0.11.0 is officially released, it could happen that "the part of the Embulk core can no longer be changed", and there would be no way. Please try v0.10.48 before it happens.
